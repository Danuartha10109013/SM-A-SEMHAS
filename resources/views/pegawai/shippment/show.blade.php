                            ...
                            @else
                                @foreach ($data as $d)
                                    <tr>
                                        ...
                                        <td><a href="{{route('Ship-Mark.pegawai.shipment-a-printone', $d->atribute)}}" class="btn btn-primary mr-2 mb-2 text-center"><i class="ri-printer-line"></i></a>
                                        ...
                                        <a href="{{route('Ship-Mark.pegawai.shipment-a-delete', $d->id)}}" class="btn btn-danger text-center"><i class="ri-delete-bin-line"></i></a></td>
                                    </tr>
                                @endforeach
                            @endif
                        </tbody>
